# FLEXT-MELTANO Makefile - Infrastructure Component
# ====================================================
...
help: ## Show this help message
	@echo "🏗️  Flext Meltano - Infrastructure Component"
	@echo "=========================================="
...
# Testing
test: ## Run tests
	@echo "🧪 Running tests for flext-meltano..."
	@if [ -d tests ]; then \
...
test-coverage: ## Run tests with coverage
	@echo "🧪 Running tests with coverage for flext-meltano..."
	@python -m pytest tests/ --cov=src --cov-report=html --cov-report=term

# Code Quality - Maximum Strictness
lint: ## Run all linters with maximum strictness
	@echo "🔍 Running maximum strictness linting for flext-meltano..."
...
build-clean: clean build ## Clean then build
	@echo "🔄 Clean build for flext-meltano..."
...
publish: build ## Publish to PyPI
	@echo "🚀 Publishing flext-meltano to PyPI..."
	poetry publish

# Documentation
docs: ## Generate documentation
	@echo "📚 Generating documentation for flext-meltano..."
...
clean: ## Clean build artifacts
	@echo "🧹 Cleaning build artifacts for flext-meltano..."
...
dev-setup: install-dev ## Complete development setup
	@echo "🎯 Setting up development environment for flext-meltano..."
	poetry run pre-commit install
	mkdir -p reports
	@echo "✅ Development setup complete!"

dev: ## Run in development mode
	@echo "🔧 Starting flext-meltano in development mode..."
	PYTHONPATH=src poetry run python -m flext_meltano --debug
