...
This directory contains comprehensive documentation for the FLEXT Meltano enterprise data integration library.
...
2. **Follow the [Quick Start Guide](examples/quick-start.md)** for basic usage
3. **Review [API Reference](api/README.md)** for detailed interface documentation
4. **Check [Development Guide](guides/development.md)** for contribution guidelines
...
- **Consistency**: Aligned with CLAUDE.md and README.md
