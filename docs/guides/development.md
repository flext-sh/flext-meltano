<!-- Generated from docs/guides/development.md for flext-meltano. -->

<!-- Source of truth: workspace docs/guides/. -->

# flext-meltano - FLEXT Development Guide
...
def process_data(data: ProcessInputModel) -> p.Result[ProcessedData]:
...
def validate_and_process(data: ProcessInputModel) -> p.Result[ProcessedData]:
    return (
        validate_data(data)
...
class FlextNewlib:
    ...
    def process(
        self, data: NewlibProcessInputModel
    ) -> p.Result[NewlibProcessResultModel]:
