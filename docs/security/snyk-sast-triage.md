# Triagem Snyk Code (SAST) — flext-sh/flext-meltano
...
|---|---|---|---|---|---|---|
| 1 | low | Use of Hardcoded Passwords | `tests/unit/test_models.py` | 107 | - | |
...
Dados brutos: `~/snyk-violations/sast/flext-sh__flext-meltano.sast.json`
