...
```yaml
        1  # Generated by `flext-infra codegen conform` for flext-meltano — DO NOT EDIT.
        2  version: 2
        3  updates:
...
**Classe**: Insecure Configuration · **Local**: `pyproject.toml:634`
...
```toml
      630  all = true
      631  in_place = true
      632  sort_first = ["build-system", "dependency-groups", "project", "tool"]
      633  
>>>   634  [tool.uv]
      635  link-mode = "copy"
      636  
      637  [tool.vulture]
      638  exclude = ["*/_protocols/*"]
```
