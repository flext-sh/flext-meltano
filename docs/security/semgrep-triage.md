...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 634 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-meltano.json`
