...
if TYPE_CHECKING:
    ...
    from tests.helpers.docker_test_manager import ContainerManager, FlextTestsDocker
    ...
    from tests.typings import TestsFlextMeltanoTypes
...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "TestFlextMeltanoTapAbstractionsComplete": ("tests.unit.test_tap_abstractions", "TestFlextMeltanoTapAbstractionsComplete"),
