"""Test FlextMeltanoConfig Singleton Pattern with Parameter Overrides.

This module tests the singleton pattern implementation that allows parameters
to change configuration behavior while using FlextConfig as the source of truth.
...
class TestFlextMeltanoConfigSingletonPattern:
    ...
    def test_create_with_overrides(self) -> None:
        ...
        assert "project" in str(config.project_root) or config.project_root.name == "project"
