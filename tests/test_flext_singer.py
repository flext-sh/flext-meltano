...
class TestFlextSingerBridge:
    ...
    def test_create_record_message_without_time(
        self,
    ...
    def test_create_schema_message_without_keys(
        self,
        bridge: FlextSingerBridge,
    ) -> None:
    ...
    def test_create_schema_message_invalid_stream(
        self,
        bridge: FlextSingerBridge,
    ) -> None:
    ...
    def test_create_state_message_success(self, bridge: FlextSingerBridge) -> None:
        ...
        state_value = {
            "bookmarks": {"test_stream": {"timestamp": "2023-01-01T00:00:00Z"}},
        }
...
class TestFlextSingerCatalog:
    ...
    def test_catalog_initialization_empty(self, catalog: FlextSingerCatalog) -> None:
        ...
        if result.value != expected_data:
            msg: str = f"Expected {expected_data}, got {result.value}"
            raise AssertionError(msg)

    def test_catalog_initialization_with_data(
        self,
        catalog_with_data: FlextSingerCatalog,
    ) -> None:
    ...
    def test_add_stream_success(self, catalog: FlextSingerCatalog) -> None:
        ...
        streams = catalog_result.value["streams"]
        if len(streams) != 1:
    ...
    def test_add_stream_without_key_properties(
        self,
...
class TestFlextSingerFactoryFunctions:
    ...
    def test_flext_create_singer_catalog_with_data(self) -> None:
        ...
        result = catalog.flext_singer_get_catalog()
        assert result.success
        if result.value != initial_data:
            msg: str = f"Expected {initial_data}, got {result.value}"
            raise AssertionError(msg)
