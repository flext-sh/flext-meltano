"""Comprehensive tests for Base Services - Coverage approaching 100%.

This module implements REAL tests for ALL Base Services functionalities:
- FlextMeltanoTapService: Tests with REAL Singer SDK
- FlextMeltanoTargetService: Tests with REAL Target
- FlextMeltanoDbtService: Tests with REAL DBT Core
- Covering ALL public and abstract methods
- Target: 90%+ coverage for base_services.py
"""
...
class ConcreteTapService(FlextMeltanoTapService):
    ...
    def __init__(self) -> None:
        # Initialize with valid values required by Pydantic
        super().__init__(tap_name="test-tap")

    def get_tap_class(self) -> type[Tap]:
        """Returns mock Tap class for tests."""
...
class ConcreteTargetService(FlextMeltanoTargetService):
    ...
    def get_target_class(self) -> type[Target]:
        """Returns mock Target class for tests."""
        ...
        class TestTarget(Target):
            ...
            def process_record_message(self, message_dict: dict[str, object]) -> None:
    ...
    def get_default_config(self) -> dict[str, object]:
        ...
        return {"output_file": temp_file_path, "format": "json"}

    def get_required_config_fields(self) -> list[str]:
        """Override to add required fields."""
        return ["output_file"]
...
""")
    ...
    def test_run_models_with_project_dir(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = service.run_models(models=["model1"], project_dir=project_dir)
