...
_LAZY_IMPORTS: Mapping[str, Sequence[str]] = {
    ...
    "TestFlextMeltanoPipelineOperations": ["tests.unit.test_api", "TestFlextMeltanoPipelineOperations"],
    "TestFlextMeltanoPluginOperations": ["tests.unit.test_api", "TestFlextMeltanoPluginOperations"],
    "TestFlextMeltanoPluginProtocols": ["tests.unit.test_plugin_protocols", "TestFlextMeltanoPluginProtocols"],
