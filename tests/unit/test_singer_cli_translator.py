...
class TestFlextMeltanoSingerCliTranslatorExecuteCommand:
    ...
    @patch(
        "flext_core.utilities.FlextUtilities.FlextUtilities.CommandExecution.run_external_command"
    )
    ...
    def test_execute_singer_command_with_input(self, mock_run: MagicMock) -> None:
        ...
        # Verify FlextUtilities.FlextUtilities.CommandExecution.run_external_command was called with encoded input
