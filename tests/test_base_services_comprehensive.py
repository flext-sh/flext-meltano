...
class ConcreteTargetService(FlextMeltanoTargetService):
    ...
    def get_target_class(self) -> type[Target]:
        ...
        class TestTarget(Target):
            ...
            def process_record_message(self, message_dict):
...
class TestFlextMeltanoTapServiceComprehensive:
    ...
    def test_create_tap_instance_invalid_config(self) -> None:
        ...
        assert "invalid config" in result.error.lower() or "missing required field" in result.error.lower()
...
class TestFlextMeltanoDbtServiceComprehensive:
    ...
    def test_get_project_config_complete(self) -> None:
        ...
        required_fields = [
            "name", "version", "profile", "model-paths", "analysis-paths",
            "test-paths", "seed-paths", "macro-paths", "snapshot-paths",
            "target-path", "clean-targets", "models"
        ]
    ...
    def test_initialize_project_missing_dbt_yml(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert "found" in result.error.lower()  # Pode ser "not found" ou "no ... found"
...
""")
    ...
    def test_run_models_with_project_dir(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = service.run_models(mock_runner, models=["model1"], project_dir=project_dir)
    ...
    def test_test_models_functionality(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = service.test_models(mock_runner, models=["model1"], project_dir=project_dir)
...
class TestBaseServicesIntegration:
    ...
    def test_config_validation_patterns(self) -> None:
        ...
        target_valid = target_service.validate_target_config(target_service.get_default_config())
