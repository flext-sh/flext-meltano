...
class TestFlextMeltanoUtilitiesComprehensive:
    ...
    def test_create_dbt_config_minimal(self) -> None:
        ...
        expected_paths = [
            ...
            "macro-paths", "snapshot-paths", "target-path", "clean-targets"
        ]
    ...
    def test_setup_project_structure_complete(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = FlextMeltanoUtilities.setup_project_structure(project_root, project_name)
            ...
            expected_dirs = ["extract", "load", "transform", "analyze", "models", "tests", "data"]
...
class TestFlextMeltanoUtilitiesIntegration:
    ...
    def test_complete_project_creation_workflow(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            setup_result = FlextMeltanoUtilities.setup_project_structure(project_root, project_name)
    ...
    def test_config_creation_and_validation_workflow(self) -> None:
        ...
        plugin_config = FlextMeltanoUtilities.create_plugin_config("tap-test", "extractor")
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            save_result = FlextMeltanoUtilities.save_yaml_config(plugin_config, config_file)
            ...
            reloaded_config = {k: v for k, v in load_result.value.items()}
            revalidation_result = FlextMeltanoUtilities.validate_plugin_config(reloaded_config)
    ...
    def test_sanitization_integration(self) -> None:
        ...
        plugin_config = FlextMeltanoUtilities.create_plugin_config(sanitized, "extractor")
