"""Test typings extending flext_meltano.typings for test-specific type definitions.

This module provides test-specific type definitions that extend the production
types from src/flext_meltano/typings.py. All test types use real inheritance
...
class TestsTypings(FlextMeltanoTypes):
    """Test-specific type definitions extending FlextMeltanoTypes.
