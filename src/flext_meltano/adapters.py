...
class FlextMeltanoAdapter:
    ...
    def create_temporary_meltano_project(
        ...
        Args:
            ...
            prefix: Temporary directory prefix (defaults to FlextMeltanoConstants)
        ...
        try:
            ...
            temp_prefix = prefix or FlextMeltanoConstants.Meltano.APPLICATION_NAME
            temp_dir = tempfile.mkdtemp(prefix=f"{temp_prefix}_")
            temp_path = Path(temp_dir)

            # Create minimal meltano.yml configuration using constants
            meltano_config = {
                "version": FlextMeltanoConstants.Plugin.CONFIG_VERSION,
                "default_environment": FlextMeltanoConstants.Meltano.METADATA_DEFAULT_ENVIRONMENTS[
                    0
                ],
                "project_id": project_id
                or FlextMeltanoConstants.Meltano.APPLICATION_NAME,
                "environments": [
                    {
                        "name": FlextMeltanoConstants.Meltano.METADATA_DEFAULT_ENVIRONMENTS[
                            0
                        ],
                        "config": {
                            "plugins": {
                                FlextMeltanoConstants.PluginTypes.EXTRACTORS: [],
                                FlextMeltanoConstants.PluginTypes.LOADERS: [],
                                FlextMeltanoConstants.PluginTypes.TRANSFORMS: [],
                            },
                        },
                    },
                ],
    ...
    def get_project_info(self) -> FlextResult[dict[str, object]]:
        ...
        try:
            ...
            return FlextResult[dict[str, object]].ok(data=project_info)
    ...
    def get_version(self) -> FlextResult[FlextMeltanoTypes.Bridge.VersionInfo]:
        ...
        Example:
            ...
            >>> version_result: FlextResult[Project] = adapter.get_version()
    ...
    def initialize_project(
        ...
        Example:
            ...
            >>> result: FlextResult[Project] = adapter.initialize_project(project_path)
    ...
    def _load_meltano_project(self, project_root: Path) -> FlextResult[Project]:
        ...
        try:
            ...
            return FlextResult[Project].fail(f"Error loading Meltano project: {e}")
    ...
    def _cache_and_convert_project(
        ...
        try:
            ...
            # ✅ TYPE SAFETY: ConfigValue supports dict[str, FlextTypes.JsonValue] per flext-core
    ...
    def discover_plugins(
        ...
        Example:
            >>> adapter = FlextMeltanoAdapter()
            >>> plugins_result: FlextResult[Project] = adapter.discover_plugins()
        ...
        try:
            ...
            if project:
                ...
                temp_project_result: FlextResult[Project] = (
            ...
            if loaders_result.is_success:
                ...
                for _plugin_name, indexed_plugin in list(loaders_dict.items())[:5]:
                    ...
                    plugin_info = {
                        "name": plugin_name,
                        "type": FlextMeltanoConstants.Plugin.TYPE_TARGET,
                        "default_variant": str(default_var) if default_var else "",
                        "variants": ",".join(list(variants_obj.keys()))
                        if isinstance(variants_obj, dict)
                        else "",
    ...
    def create_project(
        ...
        try:
            ...
            if not project_name or not project_name.strip():
                return FlextResult[dict[str, str]].fail("Project name cannot be empty")
            ...
            return FlextResult[dict[str, str]].ok(data=project_result)
    ...
    def _validate_and_load_project(self, project_dir: Path) -> FlextResult[Project]:
        ...
        try:
            ...
            return FlextResult[Project].fail(f"Failed to load Meltano project: {e}")
    ...
    def _handle_plugin_addition_error(self, error: str) -> FlextResult[dict[str, str]]:
    ...
    def get_plugin_info(
        ...
        try:
            ...
            plugin_display_name = getattr(indexed_plugin, "name", "unknown")
            default_var = getattr(indexed_plugin, "default_variant", None)
            variants_obj = getattr(indexed_plugin, "variants", None)
            plugin_info = {
    ...
    def _find_required_plugins(
    ...
    ) -> FlextResult[tuple[ProjectPlugin, ProjectPlugin]]:
        ...
        return FlextResult[tuple[ProjectPlugin, ProjectPlugin]].ok(
    ...
    def _handle_pipeline_error(self, error: str) -> FlextResult[dict[str, str]]:
    ...
    def create_tap_stream_catalog(self) -> FlextResult[dict[str, object]]:
        ...
        Returns:
            FlextResult[dict[str, object]]: Result containing tap stream catalog.
    ...
    def create_target_config(self) -> FlextResult[dict[str, object]]:
        ...
        Returns:
            FlextResult[dict[str, object]]: Result containing target configuration.
    ...
    def convert_singer_schema(self) -> FlextResult[dict[str, object]]:
        ...
        Returns:
            FlextResult[dict[str, object]]: Result containing converted schema.
    ...
    def execute_dbt_operation(self) -> FlextResult[dict[str, object]]:
        ...
        Returns:
            FlextResult[dict[str, object]]: Result containing DBT operation status.
...
"""
    ...
    def adapt_project_config(
        ...
        Returns:
            FlextResult[dict[str, object]]: Result containing adapted configuration.
        ...
        try:
            ...
            return FlextResult[dict[str, object]].ok(data=adapted_config)
    ...
    def adapt_plugin(
        ...
        Returns:
            FlextResult[dict[str, object]]: Result containing adapted plugin data.
        ...
        try:
            ...
            return FlextResult[dict[str, object]].ok(data=adapted_plugin)
    ...
    def execute_complete_elt_pipeline(
        ...
        try:
            ...
            dbt_models = (
                cast("list[str]", dbt_models_obj)
                if dbt_models_obj and isinstance(dbt_models_obj, list)
                else None
            )
