...
class OICConnectionConfig(BaseModel):
    ...
    def validate_base_url(self) -> FlextMeltanoResult[Any]:
        ...
        return FlextMeltanoResult.ok(None)
...
class BaseOICAuthenticator(ABC):
    ...
    def get_access_token(self) -> FlextMeltanoResult[Any]:
        """Get access token using OAuth2 client credentials flow.

        Returns:
            FlextMeltanoResult containing access token or error

        """
        try:
            if not self.auth_config.oauth_token_url:
                return FlextMeltanoResult.fail("OAuth token URL not configured")
            ...
            return FlextMeltanoResult.ok(self._access_token)

        except requests.exceptions.RequestException as e:
            error_msg = f"OIC OAuth2 authentication failed: {e}"
            self.logger.exception(error_msg)
            return FlextMeltanoResult.fail(error_msg)
...
class BaseOICClient(ABC):
    ...
    def get_authenticated_session(self) -> FlextMeltanoResult[Any]:
        """Get authenticated HTTP session.

        Returns:
            FlextMeltanoResult containing authenticated session or error
        ...
        try:
            ...
            return FlextMeltanoResult.ok(self._session)
    ...
    def make_request(
        ...
        Returns:
            FlextMeltanoResult containing response data or error
        ...
        try:
            ...
            if session is None:
                return FlextMeltanoResult.fail("Failed to get authenticated session")
            ...
            if response.headers.get("content-type", "").startswith("application/json"):
                return FlextMeltanoResult.ok(response.json())
            return FlextMeltanoResult.ok({"raw_content": response.text})
            ...
            # This should not be reached due to return statements above
    ...
    def paginate_request(
        ...
        Returns:
            FlextMeltanoResult containing all paginated records or error
        ...
        try:
            ...
            while True:
                ...
                if response_data is None:
                    return FlextMeltanoResult.fail("No response data received")
            ...
            return FlextMeltanoResult.ok(all_records)
...
class OICTapClient(BaseOICClient):
    ...
    def get_integrations(
        ...
        Returns:
            FlextMeltanoResult containing integrations or error
    ...
    def get_connections(
        ...
        Returns:
            FlextMeltanoResult containing connections or error
    ...
    def get_packages(self, page_size: int = 100) -> FlextMeltanoResult[Any]:
        ...
        Returns:
            FlextMeltanoResult containing packages or error

        """
        return self.paginate_request("/packages", page_size=page_size)

    def get_lookups(self, page_size: int = 100) -> FlextMeltanoResult[Any]:
        ...
        Returns:
            FlextMeltanoResult containing lookups or error
...
class OICTargetClient(BaseOICClient):
    ...
    def create_integration(
        ...
        Returns:
            FlextMeltanoResult containing created integration or error
    ...
    def update_integration(
        ...
        Returns:
            FlextMeltanoResult containing updated integration or error
    ...
    def create_connection(
        ...
        Returns:
            FlextMeltanoResult containing created connection or error
