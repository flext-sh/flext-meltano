"""FLEXT Meltano Singer Protocol Abstractions - Unified Tap and Target abstractions.

This module provides complete Singer protocol abstractions following flext-core
single-class-per-module pattern. Consolidates ALL tap and target functionality so that
