...
class FlextMeltanoConstantsBase:
    ...
    VALIDATION_COMPLEXITY_MODERATE_MAX_SETTINGS: Final[int] = 20
    VALIDATION_DBT_SIMPLE_EXECUTION_THRESHOLD: Final[int] = 10
    VALIDATION_MAX_WORKERS_THRESHOLD: Final[int] = 100
