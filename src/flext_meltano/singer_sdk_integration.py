...
class FlextTapProtocol:
    """Protocol for FLEXT enterprise taps with advanced capabilities."""
...
class FlextTargetProtocol:
    """Protocol for FLEXT enterprise targets with advanced capabilities."""
...
class FlextSingerSDKIntegration(DomainBaseModel):
    ...
    async def create_oracle_oic_tap(self, config: TapConfig) -> FlextTapProtocol | None:
        ...
        return FlextOracleOICTap(config)

    async def create_ldap_tap(self, config: TapConfig) -> FlextTapProtocol | None:
