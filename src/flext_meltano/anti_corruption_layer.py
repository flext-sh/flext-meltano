...
class MeltanoAntiCorruptionLayer:
    """Translation layer between FLEXT domain model and Meltano concepts.
    ...
    async def translate_and_install_plugin(self, domain_plugin: Plugin) -> bool:
        ...
        Converts a FLEXT domain Plugin entity to Meltano's plugin descriptor
    ...
    async def translate_and_run_pipeline(
        ...
        Converts a FLEXT Pipeline entity to Meltano's execution format, extracting
    ...
    def _translate_plugin_to_meltano(
        ...
        Internal translation method that maps FLEXT plugin attributes to
    ...
    def _translate_meltano_to_plugin(
        ...
        FLEXT domain model, including type conversion.
        """
    ...
    def _map_meltano_type_to_domain(self, meltano_namespace: str) -> PluginType:
        """Map Meltano namespace conventions to FLEXT plugin types.

        Converts Meltano's namespace-based plugin categorization to
        FLEXT's explicit PluginType enumeration.
        """
        namespace_mapping = {
