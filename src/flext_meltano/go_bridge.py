...
class FlextMeltanoBridge:
    ...
    def run_pipeline(self, tap_name: str, target_name: str, project_root: str = ".") -> dict[str, Any]:
    ...
    def execute_meltano_command(self, command: list[str], project_root: str = ".") -> dict[str, Any]:
    ...
    def execute_dbt_command(self, command: list[str], project_root: str = ".") -> dict[str, Any]:
    ...
    def install_plugin(self, plugin_type: str, plugin_name: str, project_root: str = ".") -> dict[str, Any]:
        """Install Meltano plugin."""
        try:
            project_path = Path(project_root)
            result = self.meltano_bridge.install_plugin(project_path, plugin_type, plugin_name)
