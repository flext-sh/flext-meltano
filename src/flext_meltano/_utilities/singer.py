...
Access pattern: u.Meltano.Singer.emit_schema(), u.Meltano.Singer.process_stdin(), etc.
"""
...
class FlextMeltanoUtilitiesSinger:
    ...
    class Singer:
        """Singer-specific utility methods."""
        ...
        @staticmethod
        def emit_state(
            value: t.MutableContainerMapping,
        ) -> r[str]:
        ...
        def process_stdin(
            ...
            try:
                for line in sys.stdin:
                    ...
                    if msg_type == c.Meltano.Singer.MESSAGE_TYPE_SCHEMA:
                    ...
                    elif msg_type == c.Meltano.Singer.MESSAGE_TYPE_RECORD:
                    ...
                    elif msg_type == c.Meltano.Singer.MESSAGE_TYPE_STATE:
