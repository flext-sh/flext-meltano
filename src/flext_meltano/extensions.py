...
class ExtensionType(Enum):
    """Extension types for FLEXT enterprise platform."""
...
class FlextExtensionDefinition(DomainValueObject):
    """Definition of a FLEXT enterprise extension."""
...
class FlextExtensionProtocol:
    """Protocol for FLEXT enterprise extensions with advanced capabilities."""

    def describe(self) -> FlextExtensionDefinition: ...
...
class FlextMeltanoExtensions(DomainBaseModel):
    ...
    extensions: dict[str, FlextExtensionProtocol] = Field(
        default_factory=dict,
    ...
    def list_extensions(self) -> list[FlextExtensionDefinition]:
...
class FlextOracleOICExtension:
    """FLEXT Oracle OIC Extension implementing the missing EDK integration."""
...
class FlextLDAPExtension:
    """FLEXT LDAP Extension for enterprise directory integration."""
...
class FlextMonitoringExtension:
    """FLEXT Monitoring Extension for enterprise observability."""
...
class FlextOrchestrationExtension:
    """FLEXT Orchestration Extension for advanced pipeline management."""
...
def create_meltano_extensions(project_root: Path) -> FlextMeltanoExtensions:
    """Create Meltano extensions manager with zero boilerplate."""
    return FlextMeltanoExtensions(project_root=project_root)
