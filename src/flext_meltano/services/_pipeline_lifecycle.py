...
from flext_meltano.services._pipeline_ops import _PipelinePaths
...
def _read_pid(pipeline_name: str) -> r[tuple[int, Path]]:
    ...
    if not pid_path.exists():
        return r[tuple[int, Path]].fail(f"Pipeline '{pipeline_name}' is not running")
    try:
