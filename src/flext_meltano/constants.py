...
class FlextMeltanoConstants:
    ...
    PLATFORM_DESCRIPTION: Final[str] = (
    ...
    def is_valid_plugin_name(cls, name: str) -> bool:
        ...
        if not (1 <= len(name) <= 100):
            return False
        return bool(re.match(cls.PLUGIN_NAME_PATTERN, name))
    ...
    def is_valid_environment_name(cls, name: str) -> bool:
        ...
        if not (1 <= len(name) <= 50):
            return False
        return bool(re.match(cls.ENVIRONMENT_NAME_PATTERN, name))
    ...
    def is_valid_job_name(cls, name: str) -> bool:
        ...
        if not (1 <= len(name) <= 100):
            return False
        return bool(re.match(cls.JOB_NAME_PATTERN, name))
    ...
    def __init__(self) -> None:
        ...
        """
        msg = (
            "FlextMeltanoConstants should not be instantiated - "
