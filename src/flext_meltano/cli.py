...
class FlextMeltanoCli:
    ...
    def _register_status_commands(self) -> None:
        status_group = cli.create_group(
            name=c.Meltano.Command.STATUS, help_text="Meltano status operations"
        )
        cli.register_result_command(
            status_group,
            name="show",
    ...
    def _handle_status_health(
        self, _model: p.Meltano.StatusHealthInput
    ) -> p.Result[str]:
    ...
    def _register_plugin_commands(self) -> None:
        plugin_group = cli.create_group(
            name=c.Meltano.Command.PLUGIN, help_text="Meltano plugin operations"
        )
        cli.register_result_command(
            plugin_group,
        ...
        cli.add_group(self._app, name=c.Meltano.Command.PLUGIN, group=plugin_group)

    def _handle_plugin_list(self, model: p.Meltano.PluginListInput) -> p.Result[str]:
        plugin_type = (
    ...
    def _handle_plugin_info(self, model: p.Meltano.PluginInfoInput) -> p.Result[str]:
    ...
    def _handle_plugin_install(
        self, _model: p.Meltano.PluginInstallInput
    ) -> p.Result[str]:
    ...
    def _register_pipeline_commands(self) -> None:
        pipeline_group = cli.create_group(
            name=c.Meltano.Command.PIPELINE, help_text="Pipeline operations"
        )
        cli.register_result_command(
            pipeline_group,
        ...
        cli.add_group(self._app, name=c.Meltano.Command.PIPELINE, group=pipeline_group)

    def _handle_pipeline_create(
        self, model: p.Meltano.PipelineCreateInput
    ) -> p.Result[str]:
    ...
    def _handle_pipeline_list(
        self, _model: p.Meltano.PipelineListInput
    ) -> p.Result[str]:
    ...
    def _handle_pipeline_status(
        self, model: p.Meltano.PipelineNameInput
    ) -> p.Result[str]:
