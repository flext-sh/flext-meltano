...
_LAZY_IMPORTS: Mapping[str, Sequence[str]] = {
    ...
    "FlextMeltanoAbstractionsBase": ["flext_meltano.services._abstractions_base", "FlextMeltanoAbstractionsBase"],
    ...
    "FlextMeltanoDbtAdapter": ["flext_meltano.services.adapter_extensions", "FlextMeltanoDbtAdapter"],
    "FlextMeltanoDbtManager": ["flext_meltano.services._cli_small_managers", "FlextMeltanoDbtManager"],
    ...
    "FlextMeltanoExecutorBase": ["flext_meltano.services._executor_base", "FlextMeltanoExecutorBase"],
    ...
    "FlextMeltanoModelsCliParams": ["flext_meltano._models.cli_params", "FlextMeltanoModelsCliParams"],
    "FlextMeltanoModelsContext": ["flext_meltano._models.context", "FlextMeltanoModelsContext"],
    "FlextMeltanoModelsCore": ["flext_meltano._models.core", "FlextMeltanoModelsCore"],
    "FlextMeltanoModelsDiscovery": ["flext_meltano._models.discovery", "FlextMeltanoModelsDiscovery"],
    "FlextMeltanoModelsInstances": ["flext_meltano._models.instances", "FlextMeltanoModelsInstances"],
    "FlextMeltanoModelsInstancesData": ["flext_meltano._models.instances_data", "FlextMeltanoModelsInstancesData"],
    "FlextMeltanoModelsLogging": ["flext_meltano._models.logging_config", "FlextMeltanoModelsLogging"],
    "FlextMeltanoModelsPayloads": ["flext_meltano._models.payloads", "FlextMeltanoModelsPayloads"],
    "FlextMeltanoModelsPayloadsData": ["flext_meltano._models.payloads_data", "FlextMeltanoModelsPayloadsData"],
    "FlextMeltanoModelsProjects": ["flext_meltano._models.projects", "FlextMeltanoModelsProjects"],
    "FlextMeltanoModelsProjectsPlugin": ["flext_meltano._models.projects_plugin", "FlextMeltanoModelsProjectsPlugin"],
    "FlextMeltanoModelsResults": ["flext_meltano._models.results", "FlextMeltanoModelsResults"],
    "FlextMeltanoModelsResultsDbt": ["flext_meltano._models.results_dbt", "FlextMeltanoModelsResultsDbt"],
    "FlextMeltanoModelsResultsPipeline": ["flext_meltano._models.results_pipeline", "FlextMeltanoModelsResultsPipeline"],
    "FlextMeltanoModelsSinger": ["flext_meltano._models.singer", "FlextMeltanoModelsSinger"],
    "FlextMeltanoModelsSingerCatalog": ["flext_meltano._models.singer_catalog", "FlextMeltanoModelsSingerCatalog"],
    "FlextMeltanoModelsSingerSdk": ["flext_meltano._models.singer_sdk", "FlextMeltanoModelsSingerSdk"],
    "FlextMeltanoModelsSources": ["flext_meltano._models.sources", "FlextMeltanoModelsSources"],
    "FlextMeltanoModelsSourcesParams": ["flext_meltano._models.sources_params", "FlextMeltanoModelsSourcesParams"],
    "FlextMeltanoModelsTransformations": ["flext_meltano._models.transformations", "FlextMeltanoModelsTransformations"],
    "FlextMeltanoOrchestrationService": ["flext_meltano.meltano.pipelines", "FlextMeltanoOrchestrationService"],
    "FlextMeltanoPipelineAdapter": ["flext_meltano.services.adapter_extensions", "FlextMeltanoPipelineAdapter"],
    "FlextMeltanoPipelineCrudOperations": ["flext_meltano.services._pipeline_ops", "FlextMeltanoPipelineCrudOperations"],
    "FlextMeltanoPipelineLifecycleOperations": ["flext_meltano.services._pipeline_lifecycle", "FlextMeltanoPipelineLifecycleOperations"],
    "FlextMeltanoPipelineManager": ["flext_meltano.services._pipeline_mgr", "FlextMeltanoPipelineManager"],
    "FlextMeltanoPipelinePaths": ["flext_meltano.services._pipeline_ops", "FlextMeltanoPipelinePaths"],
    "FlextMeltanoPluginDiscoveryMixin": ["flext_meltano.meltano.plugin_discovery", "FlextMeltanoPluginDiscoveryMixin"],
    "FlextMeltanoPluginManager": ["flext_meltano.services._cli_small_managers", "FlextMeltanoPluginManager"],
    ...
    "FlextMeltanoStatusManager": ["flext_meltano.services._cli_small_managers", "FlextMeltanoStatusManager"],
    ...
    "FlextMeltanoYamlOperationsMixin": ["flext_meltano.services.yaml_operations", "FlextMeltanoYamlOperationsMixin"],
    "OPERATION_ERRORS": ["flext_meltano.services._abstractions_base", "OPERATION_ERRORS"],
