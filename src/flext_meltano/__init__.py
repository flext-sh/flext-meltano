...
from .funcao1_wrapper_meltano import MeltanoBridge, FlextMeltanoAdapter
from .funcao1_wrapper_dbt import MeltanoDbtWrapper, FlextDbtAdapter
from .funcao1_wrapper_singer import MeltanoSingerWrapper, FlextSingerAdapter

# === FUNÇÃO 2: RUNTIME EXECUTION VIA GO BRIDGE ===
from .funcao2_runtime_executor import FlextMeltanoExecutor, FlextExecutionResult
from .funcao2_runtime_bridge import FlextMeltanoBridge
from .funcao2_runtime_cli import FlextMeltanoCli, flext_meltano_run_cli

# === FUNÇÃO 3: BASE COMPONENTS FOR FLEXT-* PROJECTS ===
from .funcao3_base_services import (
    FlextMeltanoTapService,
    FlextMeltanoTargetService,
    FlextMeltanoDbtService,
)
from .funcao3_base_plugins import (
    FlextTapPlugin,
    FlextTargetPlugin,
    FlextDbtPlugin,
)
...
from .funcao3_base_projects import FlextMeltanoConfig
...
__all__ = [
    ...
    # === CORE ===
    "FlextMeltanoConfig", "FlextMeltanoError", "FLEXT_MELTANO_VERSION", "FlextMeltanoCli",

    # === VALIDATION FUNCTIONS ===
    "validate_config_value", "validate_directory_path", "validate_file_path",
]
