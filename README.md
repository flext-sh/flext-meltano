...
- Primary facades: `FlextMeltanoExecutor`, `FlextMeltanoProtocolsProject`, `FlextMeltanoTypingsSinger`, `FlextMeltanoConstantsSettings`, `FlextMeltanoBridge`, `FlextMeltanoModelsSourcesParams` (+73 more)
- Alias namespaces: `c`, `d`, `e`, `h`, `m`, `p`, `r`, `s`, `t`, `u`, `x`
- Public symbol exports: `87`
...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-meltano` self).
...
- Public extensions exposed by this project: `FlextMeltanoExecutor`, `FlextMeltanoProtocolsProject`, `FlextMeltanoTypingsSinger`, `FlextMeltanoConstantsSettings`, `FlextMeltanoBridge`, `FlextMeltanoModelsSourcesParams` (+73 more).
